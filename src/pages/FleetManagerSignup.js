...
const FleetManagerSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Map new NeuroFleetX fields to backend expected keys for compatibility
    const teacherData = {
      firstName: rawData.firstName,
      lastName: rawData.lastName,
      email: rawData.email,
      phone: rawData.phone,
      // backend expects employeeId and department; map fleetId/companyName
      employeeId: rawData.fleetId,
      department: rawData.companyName,
